...
function brand(logo: string) {
  return `<image href="${logo}" x="64" y="48" width="46" height="46"/>
    <text x="123" y="84" fill="#ffffff" font-family="Arial, sans-serif" font-size="34" font-weight="700" letter-spacing="-1.5">drocsid<tspan fill="#ff7654">.</tspan></text>`;
}
...
export async function renderSiteOpenGraphImage() {
  ...
  return render(
    document(
      ...
      <text x="96" y="140" fill="#d9d9df" font-family="Arial, sans-serif" font-size="13" font-weight="600">OPEN SOURCE</text>
      <text x="64" y="242" fill="#ffffff" font-family="Arial, sans-serif" font-size="66" font-weight="700" letter-spacing="-3.5">
        <tspan x="64" y="242">A place for</tspan>
        <tspan x="64" y="310" fill="#ff7654">your people.</tspan>
      </text>
      <text x="68" y="365" fill="#d4d4dc" font-family="Arial, sans-serif" font-size="22">
      ...
      <g transform="rotate(-2 870 315)" filter="url(#panel-shadow)">
        ...
        <text x="658" y="125" fill="#e8e8eb" font-family="Arial, sans-serif" font-size="12" font-weight="600">The Common Room</text>
        ...
        <text x="642" y="176" fill="#ffffff" font-family="Arial, sans-serif" font-size="13" font-weight="700">The Common Room</text>
        <text x="642" y="211" fill="#747781" font-family="Arial, sans-serif" font-size="9" font-weight="700" letter-spacing="1">CONVERSATIONS</text>
        <rect x="636" y="226" width="130" height="31" rx="8" fill="#ffffff" fill-opacity=".08"/>
        <text x="648" y="246" fill="#ff8a6c" font-family="Arial, sans-serif" font-size="12" font-weight="600">#  general</text>
        <text x="648" y="280" fill="#a4a5ad" font-family="Arial, sans-serif" font-size="12">#  introductions</text>
        <text x="648" y="311" fill="#a4a5ad" font-family="Arial, sans-serif" font-size="12">#  making-things</text>
        <text x="642" y="359" fill="#747781" font-family="Arial, sans-serif" font-size="9" font-weight="700" letter-spacing="1">DIRECT MESSAGES</text>
        <circle cx="651" cy="385" r="10" fill="#d4dfbd"/>
        <text x="669" y="389" fill="#a4a5ad" font-family="Arial, sans-serif" font-size="11">Amara</text>
        <circle cx="651" cy="417" r="10" fill="#e3dced"/>
        <text x="669" y="421" fill="#a4a5ad" font-family="Arial, sans-serif" font-size="11">Milo</text>
        <rect x="778" y="142" width="362" height="388" fill="#121318"/>
        <rect x="778" y="142" width="362" height="55" fill="#17181d"/>
        <text x="799" y="175" fill="#ffffff" font-family="Arial, sans-serif" font-size="15" font-weight="700"># general</text>
        <line x1="778" y1="197" x2="1140" y2="197" stroke="#ffffff" stroke-opacity=".07"/>
        <circle cx="806" cy="231" r="15" fill="#f2bc95"/>
        <text x="832" y="225" fill="#ffffff" font-family="Arial, sans-serif" font-size="11" font-weight="700">Nia</text>
        <text x="832" y="243" fill="#b9bac2" font-family="Arial, sans-serif" font-size="11">Anyone up for a tiny creative sprint?</text>
        <circle cx="806" cy="282" r="15" fill="#e3dced"/>
        <text x="832" y="276" fill="#ffffff" font-family="Arial, sans-serif" font-size="11" font-weight="700">Milo</text>
        <text x="832" y="294" fill="#b9bac2" font-family="Arial, sans-serif" font-size="11">Yes. Sharing what I’m making now ✦</text>
        ...
        <text x="832" y="390" fill="#ffffff" font-family="Arial, sans-serif" font-size="11" font-weight="700">Amara</text>
        <text x="832" y="408" fill="#b9bac2" font-family="Arial, sans-serif" font-size="11">This is exactly what I needed today.</text>
        <rect x="796" y="461" width="326" height="48" rx="12" fill="#202127" stroke="#ffffff" stroke-opacity=".08"/>
        <text x="814" y="490" fill="#71737d" font-family="Arial, sans-serif" font-size="11">Message #general</text>
      ...
      <text x="135" y="527" text-anchor="middle" fill="#321711" font-family="Arial, sans-serif" font-size="15" font-weight="700">drocsid.app</text>
      <text x="64" y="585" fill="#aeb0ba" font-family="Arial, sans-serif" font-size="15">Text-first. Open source. Yours to shape.</text>
    `,
    ),
  );
}
...
export async function renderInviteOpenGraphImage(
  ...
  const icon = communityIcon
    ...
    : `<rect x="884" y="202" width="156" height="156" rx="42" fill="#ffffff" fill-opacity=".62"/>
       <text x="962" y="311" text-anchor="middle" fill="${tone.foreground}" font-family="Arial, sans-serif" font-size="78" font-weight="700">${initial}</text>`;
  ...
  return render(
    document(
      ...
      <text x="108" y="174" fill="#d9d9df" font-family="Arial, sans-serif" font-size="13" font-weight="600">COMMUNITY INVITE</text>
      <text x="76" y="232" fill="#adafba" font-family="Arial, sans-serif" font-size="22">You’re invited to</text>
      <text fill="#ffffff" font-family="Arial, sans-serif" font-size="56" font-weight="700" letter-spacing="-2.8">${textLines(nameLines, 74, 292, 59)}</text>
      <text fill="#c6c7ce" font-family="Arial, sans-serif" font-size="20">${textLines(descriptionLines, 78, descriptionY, 29)}</text>
      <text x="78" y="505" fill="#8e909b" font-family="Arial, sans-serif" font-size="15">drocsid.cc/${escapeXml(invite.code)}</text>
      ...
      ${icon}
      <text x="962" y="401" text-anchor="middle" fill="${tone.foreground}" font-family="Arial, sans-serif" font-size="18" font-weight="700">${community.members.toLocaleString("en-US")} ${community.members === 1 ? "member" : "members"}</text>
      <rect x="853" y="432" width="218" height="45" rx="22.5" fill="#ffffff" fill-opacity=".62"/>
      <text x="962" y="460" text-anchor="middle" fill="${tone.foreground}" font-family="Arial, sans-serif" font-size="14" font-weight="700">Join the conversation  →</text>
      <text x="64" y="590" fill="#aeb0ba" font-family="Arial, sans-serif" font-size="15">A place for your people.</text>
      <text x="1136" y="590" text-anchor="end" fill="#ffffff" font-family="Arial, sans-serif" font-size="15" font-weight="700">Drocsid</text>
    `,
    ),
  );
}
