...
export function AppShell() {
  ...
  return (
    <div
      ...
      className={`${workspaceTheme} flex w-full h-svh overflow-hidden bg-(--a-bg) text-(--a-text) font-sans text-(length:--a-font) data-[ui~=text-large]:[--a-font:16px] [&_button:disabled]:opacity-45 [&_button:disabled]:cursor-not-allowed [&_input:focus]:border-[#a7b78c] [&_input:focus]:shadow-[0_0_0_3px_#80985616] [&_textarea:focus]:border-[#a7b78c] [&_textarea:focus]:shadow-[0_0_0_3px_#80985616] [&_select:focus]:border-[#a7b78c] [&_select:focus]:shadow-[0_0_0_3px_#80985616] [&_input::placeholder]:text-(--a-faint) [&_textarea::placeholder]:text-(--a-faint) [&_summary::-webkit-details-marker]:hidden data-[ui~=workspace-standalone]:overflow-y-auto [&[data-ui~=workspace-standalone]_[data-ui~=a-main]]:overflow-auto [&[data-ui~=theme-dark]_input:focus]:border-[#888888] [&[data-ui~=theme-dark]_input:focus]:shadow-[0_0_0_3px_#ffffff08] [&[data-ui~=theme-dark]_textarea:focus]:border-[#888888] [&[data-ui~=theme-dark]_textarea:focus]:shadow-[0_0_0_3px_#ffffff08] [&[data-ui~=theme-dark]_select:focus]:border-[#888888] [&[data-ui~=theme-dark]_select:focus]:shadow-[0_0_0_3px_#ffffff08] max-[760px]:flex-col`}
    >
      {!standalone && (
        <>
          <header
