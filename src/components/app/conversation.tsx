    ...
    >
      ...
      {!readOnly && !editing && !message.sending && !message.sendError && (
        <div
          ...
          className="flex items-center absolute right-5.5 -top-3.75 p-0.75 bg-(--a-surface) border border-solid border-(--a-border) rounded-[7px] shadow-[0_3px_7px_#1d2c0907] opacity-0 -translate-y-1 pointer-events-none z-5 [transition:opacity_0.15s_var(--ease-out-quart),translate_0.15s_var(--ease-out-quart)] [&:has([data-ui~=a-message-menu][aria-expanded='true'])]:z-40 [&:has([data-ui~=a-message-menu][aria-expanded='true'])]:opacity-100 [&:has([data-ui~=a-message-menu][aria-expanded='true'])]:pointer-events-auto **:data-[ui~=a-icon-button]:w-7 **:data-[ui~=a-icon-button]:h-6.75 [&_[data-ui~=a-icon-button]_svg]:w-4 max-[760px]:right-4.5 max-[760px]:-top-3 max-[760px]:**:data-[ui~=a-icon-button]:w-7.5 max-[760px]:**:data-[ui~=a-icon-button]:h-7.25 max-[480px]:shadow-none max-[480px]:translate-y-0 max-[480px]:self-end max-[480px]:absolute max-[480px]:top-2 max-[480px]:right-1.75 max-[480px]:flex max-[480px]:opacity-100 max-[480px]:pointer-events-auto max-[480px]:p-0 max-[480px]:border-0 max-[480px]:border-none max-[480px]:border-[currentColor] max-[480px]:bg-transparent max-[480px]:m-0 max-[480px]:*:data-[ui~=a-icon-button]:hidden max-[480px]:[&_[data-ui~=a-message-menu]]:flex max-[480px]:[&_[data-ui~=a-message-menu]]:size-6 [&:has([data-ui~=a-emoji-trigger][aria-expanded='true'])]:opacity-100 [&:has([data-ui~=a-emoji-trigger][aria-expanded='true'])]:pointer-events-auto max-[480px]:*:data-[ui~=a-emoji-trigger]:flex"
        >
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="flex items-center justify-center w-7.5 h-7.25 bg-[#f5a383] text-[#975a3a] rounded-md [transition:background_0.15s,translate_0.12s_var(--ease-out-quart),scale_0.12s_var(--ease-out-quart)] hover:-translate-y-px [&:hover:not(:disabled)]:bg-[#f1865f] active:translate-y-0 active:scale-95 disabled:opacity-50 disabled:hover:translate-y-0 motion-reduce:hover:translate-y-0"
            type="submit"
